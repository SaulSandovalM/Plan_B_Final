...
import {Container,Text,Button, Content, CardItem, List, Left, ListItem, Body, Icon, Title, Picker, Item, Fab, Input} from 'native-base';
...
export default class Example extends Component {
  ...
  _renderModalContent = () => (
    ...
    <View style={styles.rootContainer}>
        ...
        <Button transparent onPress={() => this.setState({visibleModal: null})}><Text style={styles.texto}>Aceptar</Text></Button>
        </View>
  ...
  render() {
    return (
      ...
      <Fab active={this.state.active} direction="up" containerStyle={{}}
         position="bottomRight" onPress={() => this.setState({visibleModal: 1})}>
        <Icon name="add"/>
      </Fab>
