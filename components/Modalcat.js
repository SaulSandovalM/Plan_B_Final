...
export default class Gasto extends Component {
  ...
  _renderModalContentcat = () => (<Catlistconte lista={this.state.lista} iFun={this.props.iFun} conFun={this.props.conFun} cateFun={this.props.cateFun} icateFun={this.icateFun} modFun={this.modFun}/>);
